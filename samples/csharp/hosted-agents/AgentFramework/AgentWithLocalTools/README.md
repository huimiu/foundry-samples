...
**Bash:**
```bash
azd ai agent invoke --local '{"input": "I need a hotel in Seattle from 2025-03-15 to 2025-03-18, budget under $200 per night", "stream": false}'
```
...
```bash
azd ai agent invoke '{"input": "I need a hotel in Seattle from 2025-03-15 to 2025-03-18, budget under $200 per night", "stream": false}'
```
