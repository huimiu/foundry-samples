...
**Bash:**
```bash
azd ai agent invoke --local '{"input": "Hi! I need help understanding the return policy."}'
```
...
```bash
azd ai agent invoke '{"input": "Hi! I need help understanding the return policy."}'
```
