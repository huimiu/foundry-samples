...
**Bash:**
```bash
azd ai agent invoke --local '{"input": "Please summarize the Azure AI Agent documentation related to MCP Tool calling?"}'
```
...
```bash
azd ai agent invoke '{"input": "Please summarize the Azure AI Agent documentation related to MCP Tool calling?"}'
```
