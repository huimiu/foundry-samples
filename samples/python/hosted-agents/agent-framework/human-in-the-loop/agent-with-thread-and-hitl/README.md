...
**Bash:**
```bash
azd ai agent invoke --local '{"input": "Add a dentist appointment on March 15th", "stream": false}'
```
...
```bash
azd ai agent invoke '{"input": "Add a dentist appointment on March 15th", "stream": false}'
```
