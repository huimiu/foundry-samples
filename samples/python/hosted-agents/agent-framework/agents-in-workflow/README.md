...
**Bash:**
```bash
azd ai agent invoke --local '{"input": "We are launching a new budget-friendly electric bike for urban commuters.", "stream": false}'
```
...
```bash
azd ai agent invoke '{"input": "We are launching a new budget-friendly electric bike for urban commuters.", "stream": false}'
```
