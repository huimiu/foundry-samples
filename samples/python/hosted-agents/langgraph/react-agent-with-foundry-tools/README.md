...
**Bash:**
```bash
azd ai agent invoke --local '{"input": "use the python tool to calculate what is 4 * 3.82. and then find its square root and then find the square root of that result", "stream": false}'
```
...
```bash
azd ai agent invoke '{"input": "use the python tool to calculate what is 4 * 3.82. and then find its square root and then find the square root of that result", "stream": false}'
```
